...
public class SysUser implements Serializable {
    ...
    @Range(min = 0, max = 2, message = ValidationConstant.USER_SEX_MSG)
    private String sex;
    ...
    @Range(min = 0, max = 1, message = ValidationConstant.USER_STATUS_MSG)
    private String status;

    @ApiModelProperty(value = "删除标志(0代表存在 1代表删除)", position = 11, example = "0")
    @Range(min = 0, max = 1, message = ValidationConstant.USER_DEL_FLAG_MSG)
