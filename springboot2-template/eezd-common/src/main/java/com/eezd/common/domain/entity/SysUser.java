...
public class SysUser implements Serializable {
    ...
    @Pattern(regexp = ValidationConstant.USERNAME_LENGTH, message = ValidationConstant.USERNAME_LENGTH_MSG)
    ...
    @ApiModelProperty(value = "用户性别(0男 1女 2未知)", position = 7, example = "0")
    @Range(min = 0, max = 2)
    private String sex;
    ...
    @Pattern(regexp = ValidationConstant.PASSWORD_LENGTH, message = ValidationConstant.PASSWORD_LENGTH_MSG)
